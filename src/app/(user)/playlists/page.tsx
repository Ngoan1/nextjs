...
import ListPlayList from "@/components/playlists/list.playlist";
...
const PlayListPage = async () => {
  ...
  const res = await sendRequest<IBackendRes<IModelPaginate<IPlaylist>>>({
    ...
    nextOption: { next: { tags: ["play-list-by-user"] } },
  });
...
// import type { Metadata } from 'next'
// import NewPlaylist from "./component/new.playlist";
// import AddPlaylistTrack from "./component/add.playlist.track";
// import CurrentTrack from "./component/current.track";
